...
// }, [])
    ...
    async fetchData() {
        ...
        const folder_info = await FileSystem.getInfoAsync(`${FileSystem.cacheDirectory}items`)
        ...
        userId == null ? console.log("userID is empty") :
                        ...
                        .on('value', snp => {
                            ...
                            snp.forEach((async child => {
                                ...
                                if (image.exists) {
                                    ...
                                    try {
                                        const newImage = await FileSystem.downloadAsync(item.img_url, path)
                                        uri = newImage.uri
                                    } catch (error) {
                                        console.log(error)
                                    }
                            ...
                            <View style={styles.section}>
                                ...
                                <TouchableOpacity
                                    onPress={() => this.props.navigation.navigate('SeeAll',
                                        {itemsData: this.state.itemsData, name: "Stationery"})}>
                                    <Text style={styles.seeAll}>See all</Text>
                                </TouchableOpacity>
                            </View>
