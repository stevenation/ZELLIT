                    ...
                    <ScrollView>
                        ...
                        <FlatList
                            ...
                            renderItem={({item}) => (
                                <TouchableOpacity onPress={async () => {
                                    ...
                                    id === item.id ? this.setState({selecetedId: null}) :
                            ...
                            <View style={{alignItems: "center", paddingHorizontal: 10}}>
                                <Switch style={{alignSelf: "flex-end"}}
                                        onValueChange={async (value) => {
                                            await this.setState({inPersonEnabled:true})
                        ...
                        <View style={{
                            ...
                            <View style={{alignItems: "center", paddingHorizontal: 10}}>
                                <Switch style={{alignSelf: "flex-end"}}
                                        onValueChange={async (value) => {
                                            this.setState({thirdPartyEnable:true})
                        ...
                        <Button
                            ...
                            onPress={async () => {
                                ...
                                // console.log(this.state.itemsData.img_url)
                                // setState(items)
                            }}/>
