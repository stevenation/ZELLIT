        ...
        <View style={styles.container}>
            ...
            <SafeAreaView>
                <View style={styles.logo}>
                    <MaterialIcon name={'emoji-people'} size={170} style={{color: COLORS.blue}}/>
                ...
                <View style={styles.inputContainer}>
                    <Input placeholder={'email@address.com'}
                           ...
                           leftIcon={<Ionicons name={'md-mail'} size={25}
                ...
                <Text style={{alignSelf: 'center', fontWeight: 'bold', marginVertical:30}}>Or Connect Using</Text>
                ...
                <View style={{flex: 1, justifyContent: 'flex-end'}}>
                    ...
                    <View style={{flexDirection: 'row', alignSelf: 'center'}}>
                        ...
                        <TouchableOpacity style={{alignSelf: 'center'}} onPress={() => navigation.navigate("SignUp")}>
                            <Text style={{color: COLORS.blue, fontWeight: '700', fontSize: 14}}> SignUp</Text>
                        </TouchableOpacity>
