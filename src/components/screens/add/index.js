...
export default class CacheImage extends React.Component {
  ...
  componentWillUnmount() {
    database()
      .ref(`Users/${this.state.USER_ID}`)
      .off('child_added', this.Unsubscribe);
  }
  ...
  render() {
    return (
      <SafeAreaView>
        <Text style={{fontSize: 24, alignSelf: 'center', fontWeight: '600'}}>
          Add Item
        </Text>
          ...
          <ScrollView>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <TouchableOpacity
                  ...
                  <Text numberOfLines={3} style={styles.conditionDescription}>
                    {item.description}
                  </Text>
                </TouchableOpacity>
              )}
            ...
            <Button
              ...
              onPress={async () => {
                ...
                if (
                  this.state.itemsData.name !== '' ||
                  this.state.itemsData.condition !== '' ||
                  this.state.itemsData.category !== ''
                ) {
